...
👉 [スライド資料](./docs/handson/slides/index.html)

ローカルで確認する場合：

```bash
cd docs/handson/slides
...
- **[環境構築手順](./docs/handson/setup/README.md)**: Cursor/Windsurfのインストール手順
- **[スライド資料](./docs/handson/slides/index.html)**: ハンズオンのスライド（Reveal.js）
- **[発表資料テンプレート](./docs/presentation/template.md)**: 発表で使用するテンプレート

### サンプル

- **[サンプルECサイト](./sample/index.html)**: 完成例のコード
- **[実装レポート例](./sample/docs/implementation-report.md)**: 実装レポートのサンプル
- **[発表資料例](./sample/docs/presentation.md)**: 発表資料のサンプル
